...
export default function TabTwoScreen() {
  ...
  return (
    <ScrollView
      ...
      contentContainerClassName="flex-grow flex-row justify-center android:pt-safe android:pl-safe android:pr-safe ios:pb-[66px] android:pb-[96px] web:pt-[64px] web:pb-[24px] pb-safe"
    >
          ...
          <Collapsible title="Android, iOS, and web support">
            <ThemedView type="backgroundElement" className="items-center">
              ...
              <Image
                ...
                className="w-full aspect-[296/171] rounded-[16px] mt-2"
              />
            </ThemedView>
          </Collapsible>
